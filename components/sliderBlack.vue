<template>
    <div class="w-full seccion-negra py-32">
        <h1 class="text-4xl text-center text-white font-semibold mb-20">POR ESO NOS PREFIEREN....</h1>
    <carousel perPage="1" paginationActiveColor="#DAA520" paginationColor="#C4C4C4">
  <slide>
    <div class="flex justify-center mx-auto">
        <div class="cuadro-testimonio space-y-10 lg:space-y-0 flex flex-col lg:flex-row items-center justify-center">
